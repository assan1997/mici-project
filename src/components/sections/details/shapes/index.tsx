  ...
  const notificationTabs = useMemo(() => [
      ...
      content: <div className="font-poppins">
        <div className="w-full h-auto bg-white flex flex-wrap p-[20px] gap-[14px]">
          ...
          <div className="border-b border-gray-100 w-[300px] h-[50px]">
            ...
            <div className="text-[14px]">
              {!data ? <ColumnSkeleton /> : data?.commercial?.id}
            </div>
          </div>
          <div className="border-b border-gray-100 w-[300px] h-[50px]">
            <div className="text-[12px] text-gray-500">
    ...
    },
    {
      ...
      content: <div className="font-poppins">
        <div className="w-full h-auto  bg-white p-[20px]">
          {
            data?.observations?.reverse().map((obs: any, index: number) => <div key={index} className="flex gap-[14px] items-center border-b border-gray-100 w-full min-h-[50px] my-[10px] py-[20px] h-auto">
              ...
              <div className="w-[300px]">
                ...
                {obs?.created_at ? <div className="text-[14px]">
                  {formatTime(
    ...
    },
    {
      ...
      content: <div className="font-poppins">
        <div className="w-full h-auto p-[20px] bg-white">
          {
            data?.performances?.reverse().map((perf: any, index: number) => <div key={index} className="flex gap-[14px] items-center border-b border-gray-100 w-full h-[50px]">
              <div className="w-[300px]">
              ...
              <div className="w-[300px]">
                ...
                {perf?.completed_at ? <div className="text-[14px]">
                  {formatTime(
    ...
    },
    {
      ...
      content: <div className="font-poppins">
        <div className="w-full h-auto bg-white p-[20px]">
          {
            data?.loggers?.reverse().map((log: any) => <div key={log.id} className="flex gap-[14px] my-[10px] items-center border-b border-gray-100 w-full h-[50px]">
              <div className="w-[300px]">
